            ...
            <div className="offcanvas_menu">
                ...
                <div className="offcanvas_menu_wrapper">
                    ...
                    <div className="top_right">
                        <ul>
                            <li className="top_links"><a href="#">My Account <i className="ion-chevron-down"></i></a>
                            ...
                            <li className="language"><a href="#"><img src="assets/img/logo/language.png" alt="" /> English <i className="ion-chevron-down"></i></a>
                            ...
                            <li className="currency"><a href="#">USD <i className="ion-chevron-down"></i></a>
                                        ...
                                        <ul>
                                            ...
                                            <li className="mega_items"><a href="shop.html">shop <i className="fa fa-angle-down"></i></a>
                                                <ul className="mega_menu">
                                                    ...
                                                    <li className="banner_menu"><a href="#"><img src="assets/img/bg/banner1.jpg" alt="" /></a></li>
                                                </ul>
                                            </li>
